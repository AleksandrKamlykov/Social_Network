...
namespace Social_network.Server.Migrations
{
    ...
    [Migration("20250302140255_fix model creating")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Social_network.Server.Models.ChatMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Social_network.Server.Models.ChatMessage", b =>
                {
                    b.HasOne("Social_network.Server.Models.ChatRoom", "ChatRoom")
                        .WithMany("Messages")
